...
| `009-session-summary-workflow` | Claude | `.worktrees/session-summary-workflow` | `009-session-summary-workflow` | clarify complete; plan next | active | 2026-04-21 | `.worktrees/session-summary-workflow/specs/009-session-summary-workflow/**` | Spec + checklist landed on branch; 3 clarifications resolved via interactive clarify (FR-004 tiered authoring, FR-010 hybrid inverted-pyramid, FR-018 optional peer-audit ledger); ready for /speckit-plan |
