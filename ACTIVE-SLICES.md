...
|---|---|---|---|---|---|---|---|---|
| `011-read-the-room-ratification` | Codex | `/Users/zmll/multica_workspaces/a43055b3-6c54-4b21-ad40-4153cad4097e/e8e6cb21/workdir/peer-coordination` | `agent/codex/e8e6cb21` | review + implement | active | 2026-04-24 | `multica/**`, `scripts/github-app-token-helper.*`, `config/app-profile.template` | PC-37 deliverable slice: shared Multica read-the-room prompt, `multica/rules.md` revision, GitHub App minting note alignment, and telemetry dependency follow-up |
