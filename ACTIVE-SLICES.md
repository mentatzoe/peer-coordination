...
|---|---|---|---|---|---|---|---|---|
| `014-cc-connect-peer-system-notice-isolation` | Codex | `/Users/zmll/multica_workspaces/a43055b3-6c54-4b21-ad40-4153cad4097e/df573111/workdir/peer-coordination` | `014-cc-connect-peer-system-notice-isolation` | review | in_review | 2026-05-12 | `specs/014-cc-connect-peer-system-notice-isolation/**`, `cc-connect/**`, `ROADMAP.md` peer-bot visibility / transport rows | Multica [PC-76](mention://issue/18c252ca-9f1c-4cc1-ae93-68b6cfdccb64): PR [#110](https://github.com/mentatzoe/peer-coordination/pull/110) isolates cc-connect-authored system/guardrail notices from allowlisted peer runtimes while preserving human/operator feedback. |
