...
|---|---|---|---|---|---|---|---|---|
| `008-drift-audit-workflow` | Claude | `.worktrees/drift-audit-workflow` | `008-drift-audit-workflow` | implement complete; ready for PR review | active | 2026-04-20 | `.worktrees/drift-audit-workflow/specs/008-drift-audit-workflow/**`, `.worktrees/drift-audit-workflow/observations/drift-audits/**`, `.worktrees/drift-audit-workflow/CLAUDE.md` | Full speckit cycle landed on branch (specify → plan → tasks → analyze → implement); 17/18 tasks done (T018 PR-open deferred pending operator review); WORKFLOW.md + COMMIT-TAXONOMY.md + README/CHANGELOG updates in observations/drift-audits/ |
| `063-bot-visibility` | Codex | `.worktrees/bot-visibility` | `codex-063-bot-visibility` | implement | active | 2026-04-20 | `.worktrees/bot-visibility/cc-connect/platform/discord/**`, `.worktrees/bot-visibility/cc-connect/docs/discord.md`, `.worktrees/bot-visibility/cc-connect/config.example.toml`, `.worktrees/bot-visibility/ACTIVE-SLICES.md` | Peer-bot allowlist for Discord message visibility; local tracker `#63`, source issue `mentatzoe/cc-connect#4` |
