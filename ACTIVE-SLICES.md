...
|---|---|---|---|---|---|---|---|---|
| `011-read-the-room-ratification` | Codex | `/Users/zmll/multica_workspaces/a43055b3-6c54-4b21-ad40-4153cad4097e/cc0ecd83/workdir/peer-coordination` | `agent/codex/cc0ecd83-pr83fix` | review + implement | active | 2026-04-24 | `multica/**` | PC-37 deliverable slice: shared Multica read-the-room prompt, `multica/rules.md` revision, GitHub App minting note alignment, and telemetry dependency follow-up. Continuing PR #83 without re-landing the helper/config assets that overlap PR #73. |
