...
|---|---|---|---|---|---|---|---|---|
| `008-drift-audit-workflow` | Claude | `.worktrees/drift-audit-workflow` | `008-drift-audit-workflow` | specify | active | 2026-04-19 | `.worktrees/drift-audit-workflow/specs/008-drift-audit-workflow/**` | Direct follow-on from merged spec 005 drift-audit rubric; produces `drift-audit.json` from `observations/drift-audits/RUBRIC.md` |
