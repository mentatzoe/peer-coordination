...
| `008-drift-audit-workflow` | Claude | `.worktrees/drift-audit-workflow` | `008-drift-audit-workflow` | review | active | 2026-04-20 | `.worktrees/drift-audit-workflow/specs/008-drift-audit-workflow/**`, `.worktrees/drift-audit-workflow/observations/drift-audits/**`, `.worktrees/drift-audit-workflow/CLAUDE.md` | Open PR [#66](https://github.com/mentatzoe/peer-coordination/pull/66) — full speckit cycle landed; 18/18 tasks complete; WORKFLOW.md + COMMIT-TAXONOMY.md runtime artifacts in observations/drift-audits/ |
| `063-bot-visibility` | Codex | `.worktrees/bot-visibility` | `codex-063-bot-visibility` | review | active | 2026-04-20 | `.worktrees/bot-visibility/cc-connect/platform/discord/**`, `.worktrees/bot-visibility/cc-connect/docs/discord.md`, `.worktrees/bot-visibility/cc-connect/config.example.toml`, `.worktrees/bot-visibility/ACTIVE-SLICES.md` | Open PR [#65](https://github.com/mentatzoe/peer-coordination/pull/65) — peer-bot allowlist for Discord message visibility; local tracker `#63`, source issue `mentatzoe/cc-connect#4`; follow-up review notes addressed |
