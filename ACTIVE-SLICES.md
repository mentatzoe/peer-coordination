...
| `006-discord-transcript-export` | Codex | `TBD on resume` | `006-discord-transcript-export` | review | parked | 2026-04-19 | `cc-connect/cmd/cc-connect/**`, `cc-connect/platform/discord/**`, `specs/006-*` (branch-local) | Draft PR [#52](https://github.com/mentatzoe/peer-coordination/pull/52); unblock on review |
| `005-drift-audit-rubric` | Claude | `TBD (not visible from current checkout)` | `005-drift-audit-rubric` | review | parked | 2026-04-19 | `specs/005-*` (branch-local) | Open PR [#50](https://github.com/mentatzoe/peer-coordination/pull/50) |
