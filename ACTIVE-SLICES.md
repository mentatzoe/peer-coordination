...
|---|---|---|---|---|---|---|---|---|
| `008-drift-audit-workflow` | Claude | `.worktrees/drift-audit-workflow` | `008-drift-audit-workflow` | tasks generated; implement next | active | 2026-04-20 | `.worktrees/drift-audit-workflow/specs/008-drift-audit-workflow/**`, `.worktrees/drift-audit-workflow/CLAUDE.md`, `.worktrees/drift-audit-workflow/observations/drift-audits/**` (during implement) | Spec + plan + tasks (18 tasks, 6 phases, US1 MVP) landed on branch; direct follow-on from merged spec 005 |
