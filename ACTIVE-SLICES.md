...
| `014-cc-connect-peer-system-notice-isolation` | Codex | `/Users/zmll/github/peer-coordination/.worktrees/014-cc-connect-peer-system-notice-isolation` | `codex-014-cc-connect-peer-system-notice-isolation` | specify + implement | active | 2026-05-12 | `specs/014-cc-connect-peer-system-notice-isolation/**`, `cc-connect/core/**`, `cc-connect/platform/discord/**`, `ACTIVE-SLICES.md` | Multica [PC-76](mention://issue/18c252ca-9f1c-4cc1-ae93-68b6cfdccb64): isolate cc-connect system/guardrail notices from allowlisted peer-bot runtime input so PC-7 parent-channel smoke can proceed without feedback loops. |
