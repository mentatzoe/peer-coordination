...
|---|---|---|---|---|---|---|---|---|
| `008-drift-audit-workflow` | Claude | `.worktrees/drift-audit-workflow` | `008-drift-audit-workflow` | plan complete; tasks next | active | 2026-04-20 | `.worktrees/drift-audit-workflow/specs/008-drift-audit-workflow/**`, `.worktrees/drift-audit-workflow/CLAUDE.md` | Spec + plan (research / data-model / contracts / quickstart) landed on branch; Constitution v1.5.0 6/6 pass; direct follow-on from merged spec 005 |
